...
qiime2.sif tools import --type MultiplexedPairedEndBarcodeInSequence --input-path ./reads --output-path 21.qza

qiime2.sif cutadapt demux-paired --p-error-rate 0.05 --verbose --p-mixed-orientation --p-minimum-length 100 --i-seqs 21.qza --o-per-sample-sequences trimmed_21.qza --o-untrimmed-sequences untrimmed_21.qza
